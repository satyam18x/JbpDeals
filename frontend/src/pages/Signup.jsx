...
const Signup = () => {
  ...
  const { signup, googleLogin } = useAppContext();
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <button 
              type="submit"
              disabled={loading}
              className="mt-6 w-full py-3 bg-accent text-card font-bold rounded-xl shadow-md hover:bg-primary hover:shadow-lg transition-all flex items-center justify-center gap-2 group disabled:opacity-50"
            >
              {loading ? 'Creating Account...' : 'Sign Up'} <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </button>
          </form>
