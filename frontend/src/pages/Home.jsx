...
import { MOCK_CATEGORIES, MOCK_BUSINESSES } from '../data/mockData';
  ...
  useEffect(() => {
    const fetchDeals = async () => {
      try {
        ...
        // Filter featured deals and limit to 4
        setFeaturedOffers(data.filter(offer => offer.isFeatured).slice(0, 4));
        setLoading(false);
      } catch (error) {
